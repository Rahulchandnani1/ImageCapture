...
const Camera = () => {
  ...
  const [aspectRatio, setAspectRatio] = useState({ width: 16, height: 9 }); // Default aspect ratio
  ...
  useEffect(() => {
    // Update the video element's aspect ratio dynamically
    if (webcamRef.current) {
